               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="美食数量" prop="meishiNumber">
                       <el-input v-model="ruleForm.meishiNumber"
                                 placeholder="美食数量" clearable  :readonly="ro.meishiNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="价格" prop="meishiMoney">
                       <el-input v-model="ruleForm.meishiMoney"
                                 placeholder="价格" clearable  :readonly="ro.meishiMoney"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   meishiNumber: [
                              { required: true, message: '美食数量不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
