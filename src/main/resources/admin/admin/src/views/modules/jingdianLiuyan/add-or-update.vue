    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="反馈内容" prop="jingdianLiuyanText">
                        <el-input type="textarea"  :readonly="ro.jingdianLiuyanText" v-model="ruleForm.jingdianLiuyanText" placeholder="反馈内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jingdianLiuyanText" label="反馈内容" prop="jingdianLiuyanText">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //当前text不能修改
            this.ro.jingdianLiuyanText = true;
            if (this.role != "管理员"){
            }
