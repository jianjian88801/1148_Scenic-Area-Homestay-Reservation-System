    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="反馈内容" prop="meishiLiuyanText">
                        <el-input type="textarea"  :readonly="ro.meishiLiuyanText" v-model="ruleForm.meishiLiuyanText" placeholder="反馈内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.meishiLiuyanText" label="反馈内容" prop="meishiLiuyanText">
