    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="24" v-if="sessionTable !='gongzuorenyuan' ">
            ...
            <input id="gongzuorenyuanId" name="gongzuorenyuanId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="体温" prop="gongzuorenyuanTiwen">
                       <el-input v-model="ruleForm.gongzuorenyuanTiwen"
                                 placeholder="体温" clearable  :readonly="ro.gongzuorenyuanTiwen"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="体温" prop="gongzuorenyuanTiwen">
                           <el-input v-model="ruleForm.gongzuorenyuanTiwen"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="工作记录" prop="gongzuorenyuanText">
                        <el-input type="textarea"  :readonly="ro.gongzuorenyuanText" v-model="ruleForm.gongzuorenyuanText" placeholder="工作记录"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gongzuorenyuanText" label="工作记录" prop="gongzuorenyuanText">
                            <span v-html="ruleForm.gongzuorenyuanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    gongzuorenyuanTiwen: false,
                    insertTime: false,
                    gongzuorenyuanText: false,
                ...
                rules: {
                   ...
                   gongzuorenyuanText: [
                              { required: true, message: '工作记录不能为空', trigger: 'blur' },
                          ],
                   gongzuorenyuanDelete: [
