               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房间配置" prop="fangjianPeizhi">
                       <el-input v-model="ruleForm.fangjianPeizhi"
                                 placeholder="房间配置" clearable  :readonly="ro.fangjianPeizhi"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="价格（天）" prop="fangjianMoney">
                       <el-input v-model="ruleForm.fangjianMoney"
                                 placeholder="价格（天）" clearable  :readonly="ro.fangjianMoney"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房间剩余数量" prop="fangjianNumber">
                       <el-input v-model="ruleForm.fangjianNumber"
                                 placeholder="房间剩余数量" clearable  :readonly="ro.fangjianNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="房间详情" prop="fangjianContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.fangjianContent" label="房间详情" prop="fangjianContent">
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    fangjianPhoto: false,
                    fangjianTese: false,
                    fangjianPeizhi: false,
                    fangjianMoney: false,
                    fangjianTypes: false,
                    fangjianNumber: false,
                    fangjianClicknum: false,
                ...
                rules: {
                   ...
                   fangjianPeizhi: [
                              { required: true, message: '房间配置不能为空', trigger: 'blur' },
                          ],
                   fangjianMoney: [
                              { required: true, message: '价格（天）不能为空', trigger: 'blur' },
                   ...
                   fangjianNumber: [
                              { required: true, message: '房间剩余数量不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   fangjianContent: [
                              { required: true, message: '房间详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
